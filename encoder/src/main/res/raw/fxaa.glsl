...
uniform float uRotation; //this is the new line
...
void main() {
    ...
    vec2 coord = uRotation == 90.0 ? vec2(vTextureCoord.y, vTextureCoord.x) : vTextureCoord;
    //this was replaced
    gl_FragColor = uAAEnabled == 1.0 ? PostFX(uSampler, coord) : texture2D(uSampler, coord);
}